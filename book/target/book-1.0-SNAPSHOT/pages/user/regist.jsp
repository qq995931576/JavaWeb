    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#code_img").click(function () {
                ...
                this.src = "${basePath}kaptcha.jpg?q=" + new Date();
        ...
        <div class="login_form">
            <div class="login_box">
                <div class="tit">
                    <h1>注册会员</h1>
                    <span class="errorMsg">
<%--									<%= request.getAttribute("errorMsg")==null?"请输入账号和密码":request.getAttribute("errorMsg") %>   --%>
									${empty requestScope.errorMsg?"请输入账号和密码":requestScope.errorMsg}
								</span>
                </div>
                <div class="form">
                    <form action="userServlet" method="post">
                        ...
                        <img alt="" src="kaptcha.jpg" style="width: 90px;height: 35px" id="code_img">
                        <br/>
                        <br/>
